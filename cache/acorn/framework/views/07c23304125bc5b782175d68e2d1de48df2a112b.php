    ...
    <div class="flex flex-wrap items-center px-4">
      <div class="w-1/2">
        <a class="brand" href="<?php echo e(home_url('/')); ?>">
          <img src=<?php echo e($heroFields['logo']); ?> alt=<?php echo $siteName; ?>>
        </a>
      </div>

      <?php if(has_nav_menu('primary_navigation')): ?>
      <div class="w-1/2 flex justify-end">
        <nav class="nav-primary hidden lg:block" aria-label="<?php echo e(wp_get_nav_menu_name('primary_navigation')); ?>">
...
</header><?php /**PATH /Users/mager/Documents/webserver/bookrepo/app/public/wp-content/themes/bookrepo/resources/views/sections/header.blade.php ENDPATH**/ ?>